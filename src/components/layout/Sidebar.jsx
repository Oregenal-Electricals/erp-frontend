...
const NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Check In',        href: '/gate/visitors',        icon: UserCheck    },
      { label: 'Active Visitors', href: '/gate/visitors',          icon: Activity     },
      { label: 'Vehicles',        href: '/gate/vehicles',        icon: Truck        },
      { label: 'Vehicle Entry',   href: '/gate/vehicles',   icon: LogIn        },
      { label: 'Active Vehicles', href: '/gate/vehicles', icon: Truck        },
  ...
  },
  {
    ...
    { label: 'Import', icon: Globe, children: [
      ...
      { label: 'LC / TT', href: '/import-orders', icon: CreditCard },
      { label: 'Shipments', href: '/shipments', icon: Truck },
      { label: 'BL / AWB', href: '/shipments', icon: FileText },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Items',       href: '/masters/products',      icon: List  },
      { label: 'BOM',         href: '/bom',        icon: ClipboardList },
      { label: 'BOM Revisions', href: '/bom-revisions', icon: GitBranch },
      { label: 'UOM',         href: '/masters/unit',        icon: Ruler },
      { label: 'Categories',  href: '/item-categories', icon: Tag       },
      ...
      { label: 'Inv. Reports', href: '/inventory-reports', icon: ClipboardList },
    ],
  },
  {
    ...
    children: [
      ...
      { label: 'IPQC', href: '/production-qc', icon: ClipboardList },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Dispatch Planning', href: '/dispatch-plans', icon: ClipboardList },
      { label: 'Dispatch', href: '/dispatches', icon: ClipboardList },
      { label: 'Delivery', href: '/delivery-confirmations', icon: ClipboardList },
      { label: 'Credit Control', href: '/credit-control', icon: ClipboardList },
    ],
  },
  {
