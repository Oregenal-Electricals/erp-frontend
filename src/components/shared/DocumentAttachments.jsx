    ...
    <div className="mt-4">
      ...
      {showUpload && (
        <div className="border rounded-xl p-4 mb-3 bg-blue-50 space-y-3">
          {error && (
            <div className="bg-red-50 text-red-600 px-3 py-2 rounded text-xs">
              {error}
            </div>
          )}
          <div
            ...
            {selectedFile ? (
              <div>
                <div className="text-xl mb-0.5">
                  {FILE_ICONS[detectFileType(selectedFile.type)]}
                </div>
      ...
      {loading ? (
        ...
        <div className="text-xs text-gray-400 py-2 text-center border border-dashed rounded-lg">
          No attachments yet
        </div>
      ) : (
