  ...
  return (
    <AppLayout>
      ...
      <PageHeader
        ...
        action={<button onClick={() => router.push('/gate/outward')} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors">← Back</button>}
      />
