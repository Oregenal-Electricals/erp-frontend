  ...
  return (
    <AppLayout>
      ...
      <PageHeader
        ...
        action={<button onClick={() => router.push('/gate/outward')} className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg text-sm font-semibold transition-colors">← Back</button>}
      />
