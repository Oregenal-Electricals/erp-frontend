...
export default function Page() {
  ...
  useEffect(()=>{
    ...
    fetch(`${API}/production-entries?limit=20`, {headers:{Authorization:`Bearer ${getToken()}`}})
  ...
  return (
    <AppLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6"><h1 className="text-2xl font-bold text-gray-900">🏭 Production Entry</h1><p className="text-gray-500 text-sm mt-1">{total} records</p></div>
