      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Diagnostic tools for existing Work Orders - check one WO&apos;s material needs, scan all active WOs
            for shortages, or see an aggregate material plan. To plan new Work Orders from open Sales Orders,
            use Production Planning instead.
          </p>
        </div>
