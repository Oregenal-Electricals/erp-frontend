...
export default function Page() {
  ...
  useEffect(()=>{
    ...
    fetch(`${API}/stock-adjustments?limit=20`, {headers:{Authorization:`Bearer ${getToken()}`}})
  ...
  return (
    <AppLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6"><h1 className="text-2xl font-bold text-gray-900">⚖️ Stock Adjustment</h1><p className="text-gray-500 text-sm mt-1">{total} records</p></div>
        ...
        <div className="bg-white rounded-xl border shadow-sm overflow-x-auto">
          ...
          :filtered.length===0?<div className="text-center py-16"><div className="text-5xl mb-3">⚖️</div><div className="text-gray-400">No records found.</div></div>:(
