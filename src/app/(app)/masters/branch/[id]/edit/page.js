...
export default function EditBranchPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await api.put(`/masters/branches/${id}`, form);
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4">
              ...
              {[
                ...
                ['Branch Name', 'name', true, true],
                ['GSTIN', 'gstin', false, true],
                ['Address', 'address', true, true],
                ['City', 'city', true, false],
                ['State', 'state', true, false],
                ['Pincode', 'pincode', true, false],
                ['Phone', 'phone', false, false],
                ['Email', 'email', false, false],
              ].map(([label, name, req, full]) => (
