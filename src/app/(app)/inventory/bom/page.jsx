    ...
    <AppLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/inventory/bom/upload" className="ml-2 border border-indigo-300 text-indigo-700 px-4 py-2 rounded-lg hover:bg-indigo-50 font-medium inline-block">Upload BOM</Link>
        </div>
